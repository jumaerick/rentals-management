...
<div id="admin-content">
        <div class="container">
            ...
            <td>{{$user->name}}</td>
            <td>{{$user->email}}</td>
            <td>{{$user->profile ? $user->profile->phone_number : '254********'}}</td>
            <td>{{$user->profile ? $user->profile->location : ''}}</td>
            <td class="view">
            ...
            <td class="delete">
            <button  data-uid='{{ $user->id }}"' class="btn btn-danger delete-student">Delete</button>
