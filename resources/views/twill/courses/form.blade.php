...
@section('contentFields')
                    ...
                    <div class="col-12 no-padding-right ">
                        <div class="row">
                            ...
                            <div class="col-4" style="margin-top:5px">
                                ...
                                <select class="multi-select" name="domain_experience_id[]" id="domain_experience_id" data-label = "Domain Experience" multiple data-multi-select>
                                    
                                    @foreach (app\Models\DomainExperience::published()->get() as $team)

                                    <option value="{{ $team->id }}" 
                                        {{ in_array($team->id, $selectedDomainIds) ? 'selected' : '' }}>
                                        {{ $team->title }}
                                    </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-12 no-padding-right ">
                        <div class="row">
                            <div class="col-2 mt-4 mb-4 ">
                                <label class="filter_by" style="color:#000">Select Interests</label>
                            </div>
                            <div class="col-4" style="margin-top:5px">

                                <select class="multi-select" name="interest_id[]" id="interest_id" data-label = "Interests" multiple data-multi-select>
                ...
                <div class="col-12 no-padding-right ">
                    <div class="row">
                        ...
                        <div class="col-4" style="margin-top:5px">
                            ...
                            <select class="multi-select" name="skill_level_id[]" id="skill_level_id" data-label = "Skill Level" multiple data-multi-select>
                            ...
                            <div class="col-12 no-padding-right ">
                                <div class="row">
                                    ...
                                    <div class="col-4" style="margin-top:5px">
                                        ...
                                        <select name="learnin_goal_id[]" id="learnin_goal_id" class="multi-select" multiple="multiple" data-label = "Learning Goals" multiple data-multi-select>
    ...
    $(document).on('click', '#department_id .multi-select-option', function () {
        ...
        $.get(url, function (data) {
            ...
            $.each(data, function (index, teamName) {
                ...
                if (isSelected) {
                    $team.append('<input type="hidden" name="team_id[]" value="' + strIndex + '">');
                }
            });
            ...
            if (
                ...
                $optionsWrapper.find('.multi-select-option.multi-select-selected').length === $optionsWrapper.find('.multi-select-option').length
            ) {
